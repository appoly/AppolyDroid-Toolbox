...
implementation("com.github.appoly.AppolyDroid-Toolbox:BaseRepo:1.7.0-beta01")
implementation("com.github.appoly.AppolyDroid-Toolbox:BaseRepo-Paging:1.7.0-beta01")
implementation("com.github.appoly.AppolyDroid-Toolbox:BaseRepo-Paging-AppolyJson:1.7.0-beta01")

// For Compose UI integration
implementation("com.github.appoly.AppolyDroid-Toolbox:LazyListPagingExtensions:1.7.0-beta01") // For LazyColumn
implementation("com.github.appoly.AppolyDroid-Toolbox:LazyGridPagingExtensions:1.7.0-beta01") // For LazyGrid
```
