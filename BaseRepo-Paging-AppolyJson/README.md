...
implementation("com.github.appoly.AppolyDroid-Toolbox:BaseRepo-Paging:1.4.0-rc01")
implementation("com.github.appoly.AppolyDroid-Toolbox:BaseRepo-Paging-AppolyJson:1.4.0-rc01")

// For Compose UI integration
implementation("com.github.appoly.AppolyDroid-Toolbox:LazyListPagingExtensions:1.4.0-rc01") // For LazyColumn
implementation("com.github.appoly.AppolyDroid-Toolbox:LazyGridPagingExtensions:1.4.0-rc01") // For LazyGrid
```
