...
implementation("com.github.appoly.AppolyDroid-Toolbox:S3Uploader-Multipart:1.7.0")
implementation("com.github.appoly.AppolyDroid-Toolbox:BaseRepo-S3Uploader-Multipart:1.7.0")
```
