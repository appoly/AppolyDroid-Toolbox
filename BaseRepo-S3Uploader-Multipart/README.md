...
implementation("com.github.appoly.AppolyDroid-Toolbox:S3Uploader-Multipart:1.2.11")
implementation("com.github.appoly.AppolyDroid-Toolbox:BaseRepo-S3Uploader-Multipart:1.2.11")
```
