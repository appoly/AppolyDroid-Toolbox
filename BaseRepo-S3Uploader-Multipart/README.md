...
implementation("com.github.appoly.AppolyDroid-Toolbox:S3Uploader-Multipart:1.5.1")
implementation("com.github.appoly.AppolyDroid-Toolbox:BaseRepo-S3Uploader-Multipart:1.5.1")
```
