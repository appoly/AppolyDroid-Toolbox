...
implementation("com.github.appoly.AppolyDroid-Toolbox:LazyListPagingExtensions:1.0.37") // For LazyColumn
implementation("com.github.appoly.AppolyDroid-Toolbox:LazyGridPagingExtensions:1.0.37") // For LazyGrid
```
